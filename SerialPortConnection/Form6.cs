...
namespace SerialPortConnection
{
    public partial class Form6 : Form
    {
        ...
        private void ReadPolarbtn_Click(object sender, EventArgs e)
        {
            ...
            string[] strArray = { "9D", "0", "0", "0", "0", "0", "0" };

            Command_tx(strArray);

            FormParameter.UART_CMD = 157;
        }
        ...
        private void ReadStatusbtn_Click(object sender, EventArgs e)
        {
            ...
            string[] strArray = { "77", "0", "0", "0", "0", "0", "0" };

            Command_tx(strArray);

            FormParameter.UART_CMD = 119;
        }
